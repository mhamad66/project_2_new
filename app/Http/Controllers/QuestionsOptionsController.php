...
class QuestionsOptionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.quiz.questions_options.index', compact('questions_options'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.quiz.questions_options.create', $relations);
    }
    ...
    public function store(StoreQuestionsOptionsRequest $request)
    {
        ...
        return redirect()->route('pages.quiz.questions_options.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.quiz.questions_options.edit', compact('questions_option') + $relations);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.quiz.questions_options.show', compact('questions_option') + $relations);
    }
